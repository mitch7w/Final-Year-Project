...
# hand tracking and detection algorithms
...
for i in range(1,1801):
    imageName = "/Users/mitch/Documents/University/Project/down_forwards_up_speed/gesture" + str(i) + ".jpg"
...
for j in range(1):
    ...
    for i in range(600):
        training_data_output.append([0,1,0]) # Forwards
    for i in range(600):
...
x_train = np.array(training_data_input[:-180])
y_train = np.array(training_data_output[:-180])
x_test = np.array(training_data_input[-180:])
y_test = np.array(training_data_output[-180:])
...
# save weights
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_down_forwards_up/conv1_weights", model.layers[0].get_weights()[0])
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_down_forwards_up/conv1_biases", model.layers[0].get_weights()[1])

np.save("../model_weights/tensorflow_gesture_detection_kinect_side_down_forwards_up/conv2_weights", model.layers[2].get_weights()[0])
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_down_forwards_up/conv2_biases", model.layers[2].get_weights()[1])

# print("Hidden Layer")
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_down_forwards_up/hidden_weights", model.layers[5].get_weights()[0])
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_down_forwards_up/hidden_biases", model.layers[5].get_weights()[1])
# print(np.array(model.layers[3].get_weights()[0]).shape)

# print("Output Layer")
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_down_forwards_up/output_weights", model.layers[6].get_weights()[0])
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_down_forwards_up/output_biases", model.layers[6].get_weights()[1])
# print("Saved weights.")
