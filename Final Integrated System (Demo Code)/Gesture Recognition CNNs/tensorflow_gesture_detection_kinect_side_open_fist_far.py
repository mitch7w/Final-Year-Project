...
for i in range(1,1401):
    imageName = "/Users/mitch/Documents/University/Project/open_fist_far/gesture" + str(i) + ".jpg"
...
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_open_fist_far/conv1_weights", model.layers[0].get_weights()[0])
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_open_fist_far/conv1_biases", model.layers[0].get_weights()[1])
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_open_fist_far/conv2_weights", model.layers[2].get_weights()[0])
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_open_fist_far/conv2_biases", model.layers[2].get_weights()[1])
...
# print("Hidden Layer")
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_open_fist_far/hidden_weights", model.layers[5].get_weights()[0])
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_open_fist_far/hidden_biases", model.layers[5].get_weights()[1])
# print(np.array(model.layers[3].get_weights()[0]).shape)

# print("Output Layer")
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_open_fist_far/output_weights", model.layers[6].get_weights()[0])
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_open_fist_far/output_biases", model.layers[6].get_weights()[1])
print("Saved weights.")
