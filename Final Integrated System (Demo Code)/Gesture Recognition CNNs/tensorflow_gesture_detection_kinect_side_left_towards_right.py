...
# hand tracking and hand detection algorithms
...
# save weights
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_left_towards_right/conv1_weights", model.layers[0].get_weights()[0])
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_left_towards_right/conv1_biases", model.layers[0].get_weights()[1])

# np.save("../model_weights/tensorflow_gesture_detection_kinect_side_left_towards_right/conv2_weights", model.layers[2].get_weights()[0])
# np.save("../model_weights/tensorflow_gesture_detection_kinect_side_left_towards_right/conv2_biases", model.layers[2].get_weights()[1])

# print("Hidden Layer")
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_left_towards_right/hidden_weights", model.layers[3].get_weights()[0])
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_left_towards_right/hidden_biases", model.layers[3].get_weights()[1])
# print(np.array(model.layers[3].get_weights()[0]).shape)

# print("Output Layer")
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_left_towards_right/output_weights", model.layers[4].get_weights()[0])
np.save("../model_weights/tensorflow_gesture_detection_kinect_side_left_towards_right/output_biases", model.layers[4].get_weights()[1])
# print("Saved weights.")
