...
if(loadWeightsFromFile):
    model.layers[1].filters = np.load("tensorflow_topdown_directions/conv_weights.npy")
    model.layers[1].bias = np.load("tensorflow_topdown_directions/conv_biases.npy")
    model.layers[4].weights = np.load("tensorflow_topdown_directions/hidden_weights.npy")
    model.layers[5].weights = np.load("tensorflow_topdown_directions/output_weights.npy")
    model.layers[4].bias = np.load("tensorflow_topdown_directions/hidden_biases.npy")
    model.layers[5].bias = np.load("tensorflow_topdown_directions/output_biases.npy")
