...
# # load Maxpooling C library
# def load_module():
#     cmodule = ctypes.cdll.LoadLibrary('./Maxpooling.so') # load library
#     # define arguments type
#     cmodule.maxpooling.argtypes = [ctypes.c_float, 
#                                     ctypes.c_int, 
#                                     ctypes.c_int, 
#                                     ctypes.c_int, 
#                                     ctypes.c_int, 
#                                     ctypes.c_int]
#     # define return type
#     cmodule.maxpooling.restype = ctypes.c_float
#     return cmodule
# cmodule = load_module()
...
class Maxpooling:
    ...
    def forward_propagation(self, previous_layer_output):
        ...
        max_pooled_values = []
        # # call c Maxpooling function for SPEED
        # max_pooled_values = cmodule.maxpooling(np.float32(previous_layer_output),  # encode the variables into the correct type
        #                         np.int32(previous_layer_output.shape[0]),
        #                         np.int32(previous_layer_output.shape[1]),
        #                         np.int32(previous_layer_output.shape[2]),
        #                         np.int32(self.pool_size),
        #                         np.int32(self.stride_size))
...
if(loadWeightsFromFile):
    model.layers[1].filters = np.load("tensorflow_gesture_detection_topdown_fist_open/conv_weights.npy")
    model.layers[1].bias = np.load("tensorflow_gesture_detection_topdown_fist_open/conv_biases.npy")
    model.layers[4].weights = np.load("tensorflow_gesture_detection_topdown_fist_open/hidden_weights.npy")
    model.layers[5].weights = np.load("tensorflow_gesture_detection_topdown_fist_open/output_weights.npy")
    model.layers[4].bias = np.load("tensorflow_gesture_detection_topdown_fist_open/hidden_biases.npy")
    model.layers[5].bias = np.load("tensorflow_gesture_detection_topdown_fist_open/output_biases.npy")
...
while cap.isOpened():
    ...
    loaded_image_new = np.array(loadImage(image)).reshape((30,30,1))
