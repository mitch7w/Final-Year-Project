...
model = Network([
    Input("sigmoid"),
    Convolution(10, (6,6,10), "sigmoid"), # num_filters, (filter_x x filter_y x num_channels)
    Maxpooling((3,3),2),
    Convolution(40, (3,3,10), "sigmoid"), # num_filters, (filter_x x filter_y x num_channels)
    Maxpooling((3,3),2),
    Flatten(),
    Hidden(100, "sigmoid"),
    Output(300, "sigmoid")])
