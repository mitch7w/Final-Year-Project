...
for j in range(1):
    for i in range(1000):
            training_data_output.append([1,0]) # Left
    for i in range(1000):
        training_data_output.append([0,1]) # Up
    # for i in range(500):
...
x_train = np.array(training_data_input[:-200])
y_train = np.array(training_data_output[:-200])
x_test = np.array(training_data_input[-200:])
y_test = np.array(training_data_output[-200:])
...
# np.save("tensorflow_gesture_detection_kinect_side_down_side_up/conv_weights", model.layers[0].get_weights()[0])
# np.save("tensorflow_gesture_detection_kinect_side_down_side_up/conv_biases", model.layers[0].get_weights()[1])

# # print("Hidden Layer")
# np.save("tensorflow_gesture_detection_kinect_side_down_side_up/hidden_weights", model.layers[3].get_weights()[0])
# np.save("tensorflow_gesture_detection_kinect_side_down_side_up/hidden_biases", model.layers[3].get_weights()[1])
# print(np.array(model.layers[3].get_weights()[0]).shape)

# # print("Output Layer")
# np.save("tensorflow_gesture_detection_kinect_side_down_side_up/output_weights", model.layers[4].get_weights()[0])
# np.save("tensorflow_gesture_detection_kinect_side_down_side_up/output_biases", model.layers[4].get_weights()[1])
