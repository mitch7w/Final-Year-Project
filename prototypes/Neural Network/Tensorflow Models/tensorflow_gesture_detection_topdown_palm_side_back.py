...
for i in range(1,391):
    imageName = "/Users/mitch/Documents/University/Project/topdown_palm_side_back/gesture" + str(i) + ".jpg"
...
x_train = np.array(training_data_input[:-39])
y_train = np.array(training_data_output[:-39])
x_test = np.array(training_data_input[-39:])
y_test = np.array(training_data_output[-39:])
...
np.save("tensorflow_topdown_palm_side_back/conv_weights", model.layers[0].get_weights()[0])
np.save("tensorflow_topdown_palm_side_back/conv_biases", model.layers[0].get_weights()[1])

# print("Hidden Layer")
np.save("tensorflow_topdown_palm_side_back/hidden_weights", model.layers[3].get_weights()[0])
np.save("tensorflow_topdown_palm_side_back/hidden_biases", model.layers[3].get_weights()[1])
print(np.array(model.layers[3].get_weights()[0]).shape)

# print("Output Layer")
np.save("tensorflow_topdown_palm_side_back/output_weights", model.layers[4].get_weights()[0])
np.save("tensorflow_topdown_palm_side_back/output_biases", model.layers[4].get_weights()[1])
