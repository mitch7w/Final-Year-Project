...
training_data_input = []
for i in range(150):
    image_filepath = "/Users/mitch/Documents/University/Project/hand_directions/gesture" + str(i) + ".jpg"
    training_data_input.append(loadImage(image_filepath))
...
x_train = np.array(training_data_input[:-15])
y_train = np.array(training_data_output[:-15])
x_test = np.array(training_data_input[-15:])
y_test = np.array(training_data_output[-15:])
