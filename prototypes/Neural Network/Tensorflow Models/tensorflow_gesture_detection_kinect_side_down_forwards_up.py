...
x_train = np.array(training_data_input[:-190])
...
# save weights
np.save("tensorflow_gesture_detection_kinect_side_down_forwards_up/conv1_weights", model.layers[0].get_weights()[0])
np.save("tensorflow_gesture_detection_kinect_side_down_forwards_up/conv1_biases", model.layers[0].get_weights()[1])

np.save("tensorflow_gesture_detection_kinect_side_down_forwards_up/conv2_weights", model.layers[2].get_weights()[0])
np.save("tensorflow_gesture_detection_kinect_side_down_forwards_up/conv2_biases", model.layers[2].get_weights()[1])

# print("Hidden Layer")
np.save("tensorflow_gesture_detection_kinect_side_down_forwards_up/hidden_weights", model.layers[5].get_weights()[0])
np.save("tensorflow_gesture_detection_kinect_side_down_forwards_up/hidden_biases", model.layers[5].get_weights()[1])
# print(np.array(model.layers[3].get_weights()[0]).shape)

# print("Output Layer")
np.save("tensorflow_gesture_detection_kinect_side_down_forwards_up/output_weights", model.layers[6].get_weights()[0])
np.save("tensorflow_gesture_detection_kinect_side_down_forwards_up/output_biases", model.layers[6].get_weights()[1])
# print("Saved weights.")
