...
np.save("tensorflow_gesture_detection_topdown_fist_open/conv_weights", model.layers[0].get_weights()[0])
np.save("tensorflow_gesture_detection_topdown_fist_open/conv_biases", model.layers[0].get_weights()[1])

# print("Hidden Layer")
np.save("tensorflow_gesture_detection_topdown_fist_open/hidden_weights", model.layers[3].get_weights()[0])
np.save("tensorflow_gesture_detection_topdown_fist_open/hidden_biases", model.layers[3].get_weights()[1])
print(np.array(model.layers[3].get_weights()[0]).shape)

# print("Output Layer")
np.save("tensorflow_gesture_detection_topdown_fist_open/output_weights", model.layers[4].get_weights()[0])
np.save("tensorflow_gesture_detection_topdown_fist_open/output_biases", model.layers[4].get_weights()[1])

print("get output at each layer for testing of FP NN")
details_file = open("tensorflow_topdown_fist_open_outputs.txt", "w+")
loaded_image = loadImage("/Users/mitch/Documents/University/Project/hand_detector_fist_open_hand/gesture1.jpg").reshape(1,input_shape[0],input_shape[1],input_shape[2])
conv_out = model.layers[0](loaded_image)
