...
//輸入WIFI連線帳號密碼
const char* ssid     = "HGU-2309";   //your network SSID
const char* password = "Engineering2022";   //your network password

//輸入AP端連線帳號密碼
const char* apssid = "HGU-2309";
const char* appassword = "Engineering2022";         //AP密碼至少要8個字元以上
